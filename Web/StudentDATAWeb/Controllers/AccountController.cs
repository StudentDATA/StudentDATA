        ...
        public ActionResult Register(RegisterModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    ...
                    UsersSettings tmpsettings = new UsersSettings();
                    tmpsettings.SemesterShow = true;
                    tmpsettings.PfhShow = true;
                    tmpsettings.FieldShow = true;
                    tmpsettings.UserKey = WebSecurity.CurrentUserId;
                    db.UsersSettingsList.Add(tmpsettings);
                    db.Entry(tmpsettings).State = System.Data.Entity.EntityState.Added;
                    db.SaveChanges();
                    return RedirectToAction("Index", "Home");
                }
